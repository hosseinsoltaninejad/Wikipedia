package ir.hossein.wikipedia.fragments
...
import ir.hossein.wikipedia.activity.DetailActivity
import ir.hossein.wikipedia.adapter.ItemEvents
import ir.hossein.wikipedia.adapter.TrendAdapter
import ir.hossein.wikipedia.data.ItemPost
import ir.hossein.wikipedia.databinding.FragmentTrendBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val dataTrend = listOf<ItemPost> (
            ...
            ItemPost(
                ...
                "John Earl Madden (April 10, 1936 â€“ December 28, 2021) was an American football coach and sportscaster. He was the head coach of the Oakland Raiders of the National Football League (NFL) for ten seasons (1969â€“1978), and guided them to a championship in Super Bowl XI (1977). After retiring from coaching, he served as a color commentator for NFL telecasts until 2009, work for which he won 16 Sports Emmy Awards. From 1988 he lent his name, expertise and color commentary to the John Madden Football (later Madden NFL) video game series.\n" +
                        "\n" +
                        "Madden never had a losing season as a coach, and his overall win percentage is second in NFL history.[1] In recognition of his coaching career, Madden was inducted into the Pro Football Hall of Fame in 2006. As a broadcaster, Madden commentated on all four of the major American television networks: CBS (1979â€“1993), Fox (1994â€“2001), ABC (2002â€“2005), and NBC (2006â€“2008). He also served as a commercial pitchman for various products and retailers.\n" +
                        "\n" +
            ...
            ItemPost(
                ...
                "Don't Look Up is a 2021 American satirical science fiction film written, produced, and directed by Adam McKay. It stars Leonardo DiCaprio and Jennifer Lawrence as two astronomers attempting to warn humanity, via a media horror, about an approaching comet that will destroy human civilization. Supporting them are Rob Morgan, Jonah Hill, Mark Rylance, Tyler Perry, TimothÃ©e Chalamet, Ron Perlman, Ariana Grande, Scott Mescudi, Himesh Patel, Melanie Lynskey, with Cate Blanchett and Meryl Streep.[4] The film is a satire of government and media indifference to the climate crisis.[4][5] Grande and Mescudi also collaborated on the song \"Just Look Up\" as part of the film's soundtrack.[6] The film is dedicated to Hal Willner who died in 2020.\n" +
                        ...
                        "\n" +
                        "Don't Look Up began a limited theatrical release on December 10, 2021, prior to streaming on Netflix on December 24, 2021. It received mixed reviews from critics, who praised the cast but found McKay's approach to the subject heavy handed. Despite the reviews, it was named one of the top ten films of 2021 by the National Board of Review and American Film Institute, and received four nominations at the 79th Golden Globe Awards, including Best Picture â€“ Musical or Comedy, and six at the 27th Critics' Choice Awards, including Best Picture.\n" +
                        "\n",
                true,
                "+362 K"
            ),
            ...
            ItemPost(
                ...
                "Margaret Campbell",
                "British socialite",
                "Ethel Margaret Campbell, Duchess of Argyll (nÃ©e Whigham, thereafter Sweeny; 1 December 1912 â€“ 25 July 1993), was a British socialite best remembered for her much-publicised divorce from her second husband, Ian Campbell, 11th Duke of Argyll, in 1963, which featured salacious photographs and scandalous stories.\n" +
                        "\n" +
            ...
            ItemPost(
                ...
                "The James Webb Space Telescope (JWST) is a space telescope developed by NASA with contributions from the European Space Agency (ESA), and the Canadian Space Agency (CSA). The telescope is named after James E. Webb, who was the administrator of NASA from 1961 to 1968 and played an integral role in the Apollo program. It is intended to succeed the Hubble Space Telescope as NASA's flagship mission in astrophysics. JWST was launched on 25 December 2021 on Ariane flight VA256. It is designed to provide improved infrared resolution and sensitivity over Hubble, and will enable a broad range of investigations across the fields of astronomy and cosmology, including observations of some of the most distant events and objects in the Universe such as the formation of the first galaxies, and allowing detailed atmospheric characterization of potentially habitable exoplanets.\n" +
                        "\n" +
                        "The primary mirror of JWST, the Optical Telescope Element, consists of 18 hexagonal mirror segments made of gold-plated beryllium, which combine to create a 6.5 m (21 ft)-diameter mirror â€“ considerably larger than Hubble's 2.4 m (7.9 ft) mirror. Unlike the Hubble telescope, which observes in the near ultraviolet, visible, and near infrared (0.1â€“1.0 Î¼m) spectra, JWST will observe in a lower frequency range, from long-wavelength visible light (red) through mid-infrared (0.6â€“28.3 Î¼m). This will enable it to observe high-redshift objects that are too old and too distant for Hubble. The telescope must be kept very cold to observe in the infrared without interference, so it will be deployed in space near the Sunâ€“Earth L2 Lagrange point, about 1.5 million kilometers (930,000 mi) from Earth (0.01 au â€“ 3.9 times the average distance to the Moon).\n" +
                        "\n",
                true,
                "+372 K"
            )
        ...
        val trendAdapter = TrendAdapter( dataTrend , this)
